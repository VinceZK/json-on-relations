...
INSERT INTO `ENTITY` VALUES ('app','Application',15,'DH001','2019-01-21 21:58:19','DH001','2019-02-08 21:15:05'),('blog','DarkHouse Blogs',5,'DH001','2018-08-08 12:00:00','DH001','2019-07-06 15:36:30'),('category','A group, often named or numbered, to which items are assigned based on similarity or defined criteria.',2,'DH001','2019-01-22 22:17:05','DH001','2019-01-22 22:29:21'),('permission','System permission',3,'DH001','2019-01-23 22:55:10','DH001','2019-07-15 23:17:19'),('person','People Entity',18,'DH001','2018-08-08 12:00:00','DH001','2019-07-21 08:52:18');
...
INSERT INTO `ENTITY_ROLES` VALUES ('app','portal_app',NULL,NULL),('blog','allowComment',NULL,NULL),('category','app_category',NULL,NULL),('mtestEntity','mtestRole01',NULL,NULL),('mtestEntity2','mtestRole02',NULL,NULL),('permission','system_role',NULL,NULL),('person','employee','TYPE','employee'),('person','husband','GENDER','male, unknown'),('person','system_user','SYSTEM_ACCESS','portal'),('person','wife','GENDER','female, unknown');
...
INSERT INTO `ROLE` VALUES ('allowComment','Allow Commenting',6,'DH001','2018-12-03 15:55:45','DH001','2018-12-03 17:39:51'),('app_category','Groups related app together',3,'DH001','2019-01-22 22:19:02','DH001','2019-02-06 14:20:46'),('employee','Company Employee',2,'DH001','2018-11-01 19:50:35','DH001','2019-06-09 21:48:05'),('husband','Husband',1,'DH001','2018-11-01 19:50:35','DH001','2018-11-01 19:50:35'),('portal_app','Application that can be accessed via portal',1,'DH001','2019-01-21 22:22:20','DH001','2019-01-21 22:22:20'),('system_role','System user role',1,'DH001','2018-11-01 19:50:35','DH001','2018-11-01 19:50:35'),('system_user','System user for login',2,'DH001','2018-11-01 19:50:35','DH001','2019-06-09 21:48:20'),('wife','Wife',9,'DH001','2018-11-01 19:50:35','DH001','2019-07-06 15:39:22');
...
INSERT INTO `ROLE_RELATION` VALUES ('allowComment','r_comment','[0..n]'),('app_category','r_app_category','[1..1]'),('employee','r_address','[0..n]'),('employee','r_email','[1..n]'),('employee','r_employee','[1..1]'),('system_role','r_role','[1..1]'),('system_user','r_personalization','[0..1]'),('system_user','r_user','[1..1]');
...
INSERT INTO `permission` VALUES ('23F3AE905E8311E9A91C03500E3C8091','Tester'),('391E75B02A1811E981F3C33C6FB0A7C1','System administrator');
...
CREATE TABLE `person` (
  ...
  `TYPE` varchar(20) DEFAULT NULL COMMENT '9796A7208A8F11E9B33AE323F41A492C',
  `SYSTEM_ACCESS` varchar(10) DEFAULT NULL COMMENT 'FF01C9708ABD11E9B33AE323F41A492C',
  PRIMARY KEY (`INSTANCE_GUID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `person` VALUES ('2FBE7490E10F11E8A90957FA46F2CECA','male',170,'Coding','ABABABABz','employee','portal'),('430C8BB0E1C611E8877F9D5C9668A7A3','female',164,'Drama','asdfasdfsadfasdf','employee','portal'),('B99348C0336D11E9820805351193F8B8','Male',180,NULL,NULL,'employee','portal');
...
-- Dump completed on 2019-07-21 10:52:41
