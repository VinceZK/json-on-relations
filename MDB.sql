...
INSERT INTO `DATA_DOMAIN_VALUE` VALUES ('ADDRESS_TYPE','CLIVE',''),('ADDRESS_TYPE','WORK',''),('DATE_FORMAT','0',''),('DATE_FORMAT','1',''),('DATE_FORMAT','2',''),('DATE_FORMAT','3',''),('DECIMAL_FORMAT','1',''),('DECIMAL_FORMAT','2',''),('EMAIL_TYPE','PRIVATE',''),('EMAIL_TYPE','WORK',''),('GENDER','Female',''),('GENDER','Male',''),('GENDER','Unknown',''),('HUMAN_AGE','1','200'),('INTEGER','1','100'),('LANGUAGE_CODE','EN',''),('LANGUAGE_CODE','ZH',''),('PERSON_TYPE','contract',''),('PERSON_TYPE','employee',''),('PERSON_TYPE','others',''),('PWD_STATE','0',''),('PWD_STATE','1',''),('PWD_STATE','2',''),('TIMEZONE','UTC+0',''),('TIMEZONE','UTC+1',''),('TIMEZONE','UTC+10',''),('TIMEZONE','UTC+11',''),('TIMEZONE','UTC+2',''),('TIMEZONE','UTC+3',''),('TIMEZONE','UTC+4',''),('TIMEZONE','UTC+5',''),('TIMEZONE','UTC+6',''),('TIMEZONE','UTC+7',''),('TIMEZONE','UTC+8',''),('TIMEZONE','UTC+9','');
...
INSERT INTO `DATA_DOMAIN_VALUE_TEXT` VALUES ('ADDRESS_TYPE','CLIVE','EN','Current live address'),('ADDRESS_TYPE','WORK','EN','Work address'),('DATE_FORMAT','0','EN','YYYYMMDD'),('DATE_FORMAT','1','EN','YYYY.MM.DD'),('DATE_FORMAT','2','EN','YYYY/MM/DD'),('DATE_FORMAT','3','EN','YYYY-MM-DD'),('DECIMAL_FORMAT','1','EN','10,000.00'),('DECIMAL_FORMAT','2','EN','10.000,00'),('EMAIL_TYPE','PRIVATE','EN','Private'),('EMAIL_TYPE','WORK','EN','Work'),('GENDER','Female','EN','Female'),('GENDER','Male','EN','Male'),('GENDER','Unknown','EN','Not clear or binsexual'),('HUMAN_AGE','1','EN','I haven\'t seen anyone who is age 201'),('INTEGER','1','EN',''),('LANGUAGE_CODE','EN','EN','English'),('LANGUAGE_CODE','ZH','EN','Chinese'),('PERSON_TYPE','contract','EN','Contract'),('PERSON_TYPE','employee','EN','Employee'),('PERSON_TYPE','others','EN','Others'),('PWD_STATE','0','EN','Initial'),('PWD_STATE','1','EN','Active'),('PWD_STATE','2','EN','Expired'),('TIMEZONE','UTC+0','EN',''),('TIMEZONE','UTC+1','EN',''),('TIMEZONE','UTC+10','EN',''),('TIMEZONE','UTC+11','EN',''),('TIMEZONE','UTC+2','EN',''),('TIMEZONE','UTC+3','EN',''),('TIMEZONE','UTC+4','EN',''),('TIMEZONE','UTC+5','EN',''),('TIMEZONE','UTC+6','EN',''),('TIMEZONE','UTC+7','EN',''),('TIMEZONE','UTC+8','EN',''),('TIMEZONE','UTC+9','EN','');
...
INSERT INTO `DATA_ELEMENT_TEXT` VALUES ('ADDRESS','EN','Address','Address'),('ADDRESS_ID','EN','Address ID','Address ID'),('ADDRESS_TYPE','EN','Address Type','Address type'),('AGE','EN','Age','Age'),('AMOUNT','EN','Amount','Amount'),('AMOUNT_LC','EN','Amount in local currency','Amount LC'),('APP_ID','EN','App ID','App ID'),('APP_NAME','EN','App Name','App Name'),('BINARY','EN','Binary','Binary'),('BIRTHDAY','EN','Birthday','Birthday'),('BOOLEAN','EN','Boolean','Boolean'),('CATEGORY_NAME','EN','Category Name','Category Name'),('CHANGE_TIME','EN','Change Time','Change Time'),('CITY','EN','City','City'),('COMPANY_ID','EN','Company ID','Company ID'),('COUNTRY','EN','Country','Country'),('CREATE_TIME','EN','Create Time','Create Time'),('DATE','EN','Date','Date'),('DATE_FORMAT','EN','Date Format','Date Format'),('DECIMAL_FORMAT','EN','Decimal Format','Decimal Format'),('DEPARTMENT_ID','EN','Department ID','Department ID'),('DESCRIPTION_MEDIUM','EN','Medium description','Descr'),('DESCRIPTION_SHORT','EN','Short Description','Descr'),('DESCRIPTION_UNLIMIT','EN','Description','Descr'),('DISPLAY_NAME','EN','Display Name','Display Name'),('EFFECTIVE_DATE','EN','Effective Date','Effective Date'),('EMAIL','EN','Email','Email'),('EMAIL_TYPE','EN','Email Type','Email Type'),('ENTITY_ID','EN','Entity ID','Entity'),('FAMILY_NAME','EN','Family Name','Family Name'),('GENDER','EN','Gender','Gender'),('GIVEN_NAME','EN','Given Name','Given Name'),('HEIGHT','EN','Height','Height'),('HOBBY','EN','Hobbies','Hobbies'),('INSTANCE_GUID','EN','Instance GUID','Instance GUID'),('INTEGER','EN','Integer','Integer'),('LANGUAGE_CODE','EN','Language ','Language '),('LOGICAL_SYSTEM','EN','Logical System','Logical System'),('MIDDLE_NAME','EN','Middle Name','Middle Name'),('ORDER','EN','Order','Order'),('PASSWORD','EN','Password','Password'),('PERSON_TYPE','EN','Person Type','Person Type'),('POSITION_TITLE','EN','Title','Title'),('POSTCODE','EN','Postcode','Postcode'),('PRIMARY','EN','Primary','Primary'),('PWD_STATE','EN','Password State','Password State'),('ROLE_NAME','EN','Role Name','Role Name'),('ROUTE_LINK','EN','Nav Link','Nav Link'),('TEXT','EN','Text','Text'),('TIMESTAMP','EN','Timestamp','Timestamp'),('TIMEZONE','EN','Timezone','Timezone'),('USER_ID','EN','User ID','User ID'),('USER_LOCK','EN','Locked','Locked'),('USER_NAME','EN','User Name','User Name'),('VALID_FROM','EN','Valid from','Valid from'),('VALID_TO','EN','Valid to','Valid to'),('VERSION_NO','EN','Version','Version');
...
INSERT INTO `person` VALUES ('2FBE7490E10F11E8A90957FA46F2CECA','Male',1.70,'Coding','ABABABA','employee','PORTAL','2019-10-03'),('430C8BB0E1C611E8877F9D5C9668A7A3','Female',1.64,'Drama','asdfasdfsadfasdf','employee','PORTAL',NULL),('B99348C0336D11E9820805351193F8B8','Male',1.91,'AAA',NULL,'employee','PORTAL',NULL);
...
INSERT INTO `r_address` VALUES (527,'China','Shanghai',201202,'Room #999, Building #99, XXX Road #999','CLIVE',1,'2FBE7490E10F11E8A90957FA46F2CECA'),(528,'China','Haimen',226126,'Village LeeZhoo','WORK',0,'2FBE7490E10F11E8A90957FA46F2CECA'),(689,'China','xxxx',200000,'xx Road ','CLIVE',1,'430C8BB0E1C611E8877F9D5C9668A7A3');
...
INSERT INTO `r_user` VALUES ('anonymous','Anonymous','pass',1,NULL,'Anonymous',NULL,'Anonymous',NULL,'B99348C0336D11E9820805351193F8B8'),('DH001','VINCEZK','Dark1234',1,NULL,'Vincent Zhang','Zhang','Vincent','zklee','2FBE7490E10F11E8A90957FA46F2CECA'),('DH002','Eleven',NULL,1,0,'Seven Eleven','Seven','Eleven',NULL,'430C8BB0E1C611E8877F9D5C9668A7A3');
...
-- Dump completed on 2019-10-19 16:34:28
